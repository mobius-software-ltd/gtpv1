...
public class ProtocolConfigurationOptionImpl extends AbstractTLV2 implements ProtocolConfigurationOption 
{
	...
	{
		return GTP2ElementType.PROTOCOL_CONFIGURATION_OPTIONS;
	}
