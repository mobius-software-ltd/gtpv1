...
import com.mobius.software.telco.protocols.gtp.api.messages.RedirectionResponse;

public class RedirectionResponseImpl extends AbstractGTPTagMessage implements RedirectionResponse
{
	private Cause cause;
	...
	{
		return MessageType.REDIRECTION_RESPONSE;
	}
