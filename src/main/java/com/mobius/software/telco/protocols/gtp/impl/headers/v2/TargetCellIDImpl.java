...
public class TargetCellIDImpl extends AbstractTLV2 implements TargetCellID 
{
	...
	{
		return GTP2ElementType.TARGET_GLOBAL_CELL_ID;
	}
	...
	protected void writeValue(ByteBuf buffer) throws MissingArgumentException 
	{
		...
		if(cellID==null)
			throw new MissingArgumentException("Cell ID is not set");
	...
	protected void readValue(ByteBuf buffer, Integer length) 
	{
		...
		cellID=buffer.readUnsignedShort();		
	}
	...
	@Override
	public void setCI(Integer cellID) 
	{
		this.cellID=cellID;
	}
}