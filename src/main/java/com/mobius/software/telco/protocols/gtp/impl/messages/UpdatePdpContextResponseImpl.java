...
import com.mobius.software.telco.protocols.gtp.api.messages.UpdatePdpContextResponse;

public class UpdatePdpContextResponseImpl extends AbstractGTPMessage implements UpdatePdpContextResponse
{
	private Cause cause;
	...
	private ChangeReportAction msInfoChangeReportAction;
	...
	{
		return MessageType.UPDATE_PDP_CONTEXT_RESPONSE;
	}
	...
	public void applyTLV(TLV1 tlv,Boolean ignoreUnknown) throws GTPParseException 
	{
		switch(tlv.getElementType())
		{
			...
			case MS_INFO_CHANGE_REPORTING_ACTION:
				msInfoChangeReportAction=(ChangeReportAction)tlv;
				break;
	...
	public List<TLV1> getTLVs() throws GTPParseException 
	{
		...
		if(msInfoChangeReportAction!=null)
			output.add(msInfoChangeReportAction);
	...
	{
		return this.msInfoChangeReportAction;
	}

	@Override
	public void setMSInfoChangeReportAction(ChangeReportAction action) 
	{
		this.msInfoChangeReportAction=action;
	}
