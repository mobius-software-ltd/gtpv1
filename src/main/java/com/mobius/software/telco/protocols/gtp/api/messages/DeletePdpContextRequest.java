...
public interface DeletePdpContextRequest extends GTPMessage 
{
	Cause getCause();
	
	void setCause(Cause cause);
	
	TeardownIndicator getTeardownIndicator();
	
	void setTeardownIndicator(TeardownIndicator teardownIndicator);
	...
	void setULITimestamp(ULITimestamp timestamp);
