...
public interface EndUserAddress extends TLV1
{
	Inet4Address getV4Address(); 
	
	Inet6Address getV6Address();
	
	PDPOrganizationType getOrganizationType();
	...
	void setPDPOrganizationType(PDPOrganizationType organizationType);
	
	void setPDPTypeNumber(PDPTypeNumber typeNumber);
}