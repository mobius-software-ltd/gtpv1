...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.DeletePDNConnectionSetResponse;

public class DeletePDNConnectionSetResponseImpl extends AbstractGTP2Message implements DeletePDNConnectionSetResponse
{
	private Cause cause;
	...
	{
		return GTP2MessageType.DELETE_PDN_CONNECTION_SET_RESPONSE;
	}
