...
import com.mobius.software.telco.protocols.gtp.api.headers.v2.TraceReference;
import com.mobius.software.telco.protocols.gtp.api.messages.v2.TraceSessionDeactivation;

public class TraceSessionDeactivationImpl extends AbstractGTP2Message implements TraceSessionDeactivation
{
	...
	{
		return GTP2MessageType.TRACE_SESSION_DEACTIVATION;
	}
	...
	public List<TLV2> getTLVs() throws GTPParseException 
	{
		...
		if(traceReference==null)
			throw new GTPParseException("Trace reference not set");
	...
	public void setTraceReference(TraceReference traceReference) 
	{
		...
		this.traceReference.setInstance(0);
	}
}