...
public interface ISRStatusIndication extends GTP2Message
{
	ActionIndication getActionIndication();
	
	void setActionIndication(ActionIndication actionIndication);
