...
public interface RANInformationRelayRequest extends GTPMessage
{
	RANTRansparentContainer getRANTRansparentContainer();
	
	void setRANTRansparentContainer(RANTRansparentContainer container);
	
	RIMRoutingAddress getRIMRoutingAddress();
	
	void setRIMRoutingAddress(RIMRoutingAddress address);
	
	RIMRoutingAddressDiscriminator getRIMRoutingAddressDiscriminator();
	
	void setRIMRoutingAddressDiscriminator(RIMRoutingAddressDiscriminator discriminator);
