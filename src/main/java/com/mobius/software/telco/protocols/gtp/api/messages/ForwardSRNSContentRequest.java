...
public interface ForwardSRNSContentRequest extends GTPMessage
{
	RABContext getRABContext();
	
	void setRABContext(RABContext rabContext);
	
	SourceRNCPDPContextInfo getSourceRNCPDPContextInfo();
	
	void setSourceRNCPDPContextInfo(SourceRNCPDPContextInfo sourceRNCPDPContextInfo);
