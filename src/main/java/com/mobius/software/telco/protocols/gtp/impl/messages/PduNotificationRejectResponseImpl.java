...
import com.mobius.software.telco.protocols.gtp.api.messages.PduNotificationRejectResponse;

public class PduNotificationRejectResponseImpl extends AbstractGTPMessage implements PduNotificationRejectResponse
{
	private Cause cause;
	...
	{
		return MessageType.PDU_NOTIFICATION_REJECT_RESPONSE;
	}
