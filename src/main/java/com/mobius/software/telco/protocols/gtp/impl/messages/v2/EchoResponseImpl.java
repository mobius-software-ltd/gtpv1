...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.EchoResponse;

public class EchoResponseImpl extends AbstractGTP2Message implements EchoResponse
{
	private Cause cause;
	...
	public List<TLV2> getTLVs() throws GTPParseException 
	{
		...
		if(recovery==null)
			throw new GTPParseException("recovery not set");
		
		output.add(recovery);
		
		if(nodeFeatures!=null)
			output.add(nodeFeatures);
	...
	@Override
	public NodeFeatures getSendingNodeFeatures() 
	{
		return nodeFeatures;
	}

	@Override
	public void setSendingNodeFeatures(NodeFeatures features) 
	{
		this.nodeFeatures=features;
		this.nodeFeatures.setInstance(0);
	}
