...
public interface CreateForwardingTunnelResponse extends GTP2Message
{
	Cause getCause();
	
	void setCause(Cause cause);
	
	S1UDataForwarding getS1UDataForwarding();
	
	void setS1UDataForwarding(S1UDataForwarding forwardingInfo);
