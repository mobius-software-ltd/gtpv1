...
public interface MBMSRegistrationResponse extends GTPMessage 
{
	Cause getCause();
	...
	RequiredMBMSBearerCapabilities getRequiredMBMSBearerCapabilities();
	
	void setRequiredMBMSBearerCapabilities(RequiredMBMSBearerCapabilities capabilities);
