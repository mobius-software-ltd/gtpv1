...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.ModifyBearerFailureIndication;

public class ModifyBearerFailureIndicationImpl extends AbstractGTP2Message implements ModifyBearerFailureIndication
{
	private Cause cause;
	...
	{
		return GTP2MessageType.MODIFY_BEARER_FAILURE_INDICATION;
	}
