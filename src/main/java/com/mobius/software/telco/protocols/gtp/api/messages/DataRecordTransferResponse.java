...
public interface DataRecordTransferResponse extends GTPTagMessage 
{
	Cause getCause();
	
	void setCause(Cause cause);
	
	RequestsResponded getRequestsResponded();
	
	void setRequestsResponded(RequestsResponded requestsResponded);
