...
import com.mobius.software.telco.protocols.gtp.api.messages.RelocationCancelResponse;

public class RelocationCancelResponseImpl extends AbstractGTPMessage implements RelocationCancelResponse
{
	private Cause cause;
	...
	{
		return MessageType.RELOCATION_CANCEL_RESPONSE;
	}
