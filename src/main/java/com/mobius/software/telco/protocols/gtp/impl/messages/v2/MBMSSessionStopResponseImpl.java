...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.MBMSSessionStopResponse;

public class MBMSSessionStopResponseImpl extends AbstractGTP2Message implements MBMSSessionStopResponse
{
	private Cause cause;
	...
	{
		return GTP2MessageType.MBMS_SESSION_STOP_RESPONSE;
	}
