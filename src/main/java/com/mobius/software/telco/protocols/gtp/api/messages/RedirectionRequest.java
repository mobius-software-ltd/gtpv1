...
public interface RedirectionRequest extends GTPTagMessage
{	
	AddressOfRecommendedNode getRecommendedNodeAddress();
	
	AddressOfRecommendedNode getAlternateRecommendedNodeAdress();
	...
	void setRecommendedNodeAddress(AddressOfRecommendedNode address);
	
	void setAlternateRecommendedNodeAdress(AddressOfRecommendedNode address);
