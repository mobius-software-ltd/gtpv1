...
import com.mobius.software.telco.protocols.gtp.api.messages.MBMSDeregistrationResponse;

public class MBMSDeregistrationResponseImpl extends AbstractGTPMessage implements MBMSDeregistrationResponse
{
	private Cause cause;
	...
	{
		return MessageType.MBMS_DEREGISTRATION_RESPONSE;
	}
