...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.ConfigurationTransferTunnel;

public class ConfigurationTransferTunnelImpl extends AbstractGTP2Message implements ConfigurationTransferTunnel
{
	...
	{
		return GTP2MessageType.CONFIGURATION_TRANSFER_TUNNEL;
	}
	...
	public List<TLV2> getTLVs() throws GTPParseException 
	{
		...
		if(eutranTransparentContainer==null)
			throw new GTPParseException("EUTRAN Transparent Container not set");
