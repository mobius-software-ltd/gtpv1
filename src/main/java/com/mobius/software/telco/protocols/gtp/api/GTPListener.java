...
{
	void onGTPMessage(GTPMessage message,InetSocketAddress sourceAddress);
	
	void onGTP2Message(GTP2Message message,InetSocketAddress sourceAddress);
	
	void onGTPTagMessage(GTPTagMessage message,InetSocketAddress sourceAddress);
}