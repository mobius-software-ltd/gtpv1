...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.UERegistrationQueryRequest;

public class UERegistrationQueryRequestImpl extends AbstractGTP2Message implements UERegistrationQueryRequest
{
	IMSI imsi;
	...
	{
		return GTP2MessageType.UE_REGISTRATION_QUERY_REQUEST;
	}
