...
import com.mobius.software.telco.protocols.gtp.api.messages.GTPTagEchoResponse;

public class GTPTagEchoResponseImpl extends AbstractGTPMessage implements GTPTagEchoResponse
{
	...
	public List<TLV1> getTLVs() throws GTPParseException 
	{
		...
		if(recovery==null)
			throw new GTPParseException("Recovery is missing");
	...
	@Override
	public void setRecovery(Recovery value) 
	{
		this.recovery=value;
	}
}