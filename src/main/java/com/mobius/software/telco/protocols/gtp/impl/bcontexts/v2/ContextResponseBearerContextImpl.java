...
import com.mobius.software.telco.protocols.gtp.api.bcontexts.v2.ContextResponseBearerContext;
...
public class ContextResponseBearerContextImpl extends BearerContextImpl implements ContextResponseBearerContext
{
	private EPSBearerID bearerID;
	private TFT tft;
	private FTEID sgwFTEID;
	private FTEID s5s8PWGFTEID;
	...
	public List<TLV2> getTLVs() throws GTPParseException 
	{
		...
		if(s5s8PWGFTEID!=null)
			output.add(s5s8PWGFTEID);
