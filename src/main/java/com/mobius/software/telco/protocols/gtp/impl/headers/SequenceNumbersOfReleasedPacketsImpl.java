...
public class SequenceNumbersOfReleasedPacketsImpl extends AbstractTLV implements SequenceNumbersOfReleasedPackets 
{
	...
	{
		return ElementType.SEQUENCE_NUMBER_OF_RELEASED_PACKETS;
	}
