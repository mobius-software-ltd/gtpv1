...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.TraceSessionActivation;

public class TraceSessionActivationImpl extends AbstractGTP2Message implements TraceSessionActivation

{
	...
	{
		return GTP2MessageType.TRACE_SESSION_ACTIVATION;
	}
	...
	public List<TLV2> getTLVs() throws GTPParseException 
	{
		...
		if(traceInformation==null)
			throw new GTPParseException("Trace Information not set");
