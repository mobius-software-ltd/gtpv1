...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.DownlinkDataNotificationFailureIndication;

public class DownlinkDataNotificationFailureIndicationImpl extends AbstractGTP2Message implements DownlinkDataNotificationFailureIndication
{
	Cause cause;
	...
	{
		return GTP2MessageType.DOWNLINK_DATA_FAILURE_INDICATION;
	}
