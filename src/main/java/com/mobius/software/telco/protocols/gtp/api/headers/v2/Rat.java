...
public enum Rat 
{	
	RESERVED(0),UTRAN(1),GERAN(2),WLAN(3),GAN(4),HSPA_EVOLUTION(5),EUTRAN(6),VIRTUAL(7),EUTRAN_NB_IoT(8),NR(10),LTE_M(28),IEEE_802(101),EHRPD(102),HRPD(103),RTT_1X(104),UMB(105),UNKNOWN(-1);
