...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.DetachNotification;

public class DetachNotificationImpl extends AbstractGTP2Message implements DetachNotification
{
	private Cause cause;
	...
	{
		return GTP2MessageType.DETACH_NOTIFICATION;
	}
	...
	@Override
	public DetachType getDetachType() 
	{
		return detachType;
	}

	@Override
	public void setDetachType(DetachType value) 
	{
		value.setInstance(0);
		this.detachType=value;
	}
}