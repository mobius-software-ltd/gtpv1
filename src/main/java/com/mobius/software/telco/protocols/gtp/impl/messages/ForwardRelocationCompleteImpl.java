...
import com.mobius.software.telco.protocols.gtp.api.messages.ForwardRelocationComplete;

public class ForwardRelocationCompleteImpl extends AbstractGTPMessage implements ForwardRelocationComplete
{
	...
	{
		return MessageType.FORWARD_RELOCATION_COMPLETE;
	}
