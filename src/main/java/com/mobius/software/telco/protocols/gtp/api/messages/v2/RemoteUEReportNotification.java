...
public interface RemoteUEReportNotification extends GTP2Message
{
	RemoteUEContext getRemoteUEContextConnected();
	
	void setRemoteUEContextConnected(RemoteUEContext context);
	
	RemoteUEContext getRemoteUEContextDisconnected();
	
	void setRemoteUEContextDisconnected(RemoteUEContext context);
