...
import com.mobius.software.telco.protocols.gtp.api.headers.LocationType;
...
public class UserLocationInformationImpl extends AbstractTLV implements UserLocationInformation 
{
	...
	{
		return ElementType.USER_LOCATION_INFORMATION;
	}
	...
	protected void writeValue(ByteBuf buffer) throws MissingArgumentException 
	{
		if(locationType==null)
			throw new MissingArgumentException("Location type is not set");
		...
		if(cell==null)
			throw new MissingArgumentException("Cell is not set");
		
		buffer.writeByte(locationType.getValue());
		...
		buffer.writeShort(cell.shortValue());
	}

	@Override
	protected void readValue(ByteBuf buffer, Integer length) 
	{
		locationType=LocationType.fromInt(buffer.readByte());
