...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.ReleaseAccessBearersResponse;

public class ReleaseAccessBearersResponseImpl extends AbstractGTP2Message implements ReleaseAccessBearersResponse
{
	private Cause cause;
	...
	{
		return GTP2MessageType.RELEASE_ACCESS_BEARER_RESPONSE;
	}
