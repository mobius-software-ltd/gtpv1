...
import com.mobius.software.telco.protocols.gtp.api.messages.UpdateMBMSContextResponse;

public class UpdateMBMSContextResponseImpl extends AbstractGTPMessage implements UpdateMBMSContextResponse
{
	private Cause cause;
	...
	{
		return MessageType.UPDATE_MBMS_CONTEXT_RESPONSE;
	}
