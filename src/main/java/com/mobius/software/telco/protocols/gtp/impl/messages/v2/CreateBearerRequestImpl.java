...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.CreateBearerRequest;

public class CreateBearerRequestImpl extends AbstractGTP2Message implements CreateBearerRequest
{
	...
	{
		return GTP2MessageType.CREATE_BEARER_REQUEST;
	}
	...
	public List<TLV2> getTLVs() throws GTPParseException 
	{
		...
		if(epsBearerID==null)
			throw new GTPParseException("EPS Bearer ID not set");
