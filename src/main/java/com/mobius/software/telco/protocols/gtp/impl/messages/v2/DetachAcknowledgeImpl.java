...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.DetachAcknowledge;

public class DetachAcknowledgeImpl extends AbstractGTP2Message implements DetachAcknowledge
{
	private Cause cause;
	...
	{
		return GTP2MessageType.DETACH_ACKNOWLEDGE;
	}
