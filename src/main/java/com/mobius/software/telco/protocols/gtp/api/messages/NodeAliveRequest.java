...
public interface NodeAliveRequest extends GTPTagMessage
{	
	ChargingGatewayAddress getNodeAddress();
	
	ChargingGatewayAddress getAlternateNodeAdress();
	
	List<PrivateExtention> getPrivateExtentions();
	
	void setPrivateExtentions(List<PrivateExtention> privateExtention);
	
	void setNodeAddress(ChargingGatewayAddress address);
	
	void setAlternateNodeAddress(ChargingGatewayAddress address);
}
