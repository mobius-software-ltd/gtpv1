...
public interface CreateIndirectDataForwardingTunnelResponseBearerContext extends TLV2
{
	...
	FTEID getS1USGWDLFTEID();
	
	void setS1USGWDLFTEID(FTEID fteid);
	
	FTEID getS12USGWDLFTEID();
	
	void setS12USGWDLFTEID(FTEID fteid);
	
	FTEID getS4USGWDLFTEID();
	
	void setS4USGWDLFTEID(FTEID fteid);
	
	FTEID getSGWDLFTEID();
	
	void setSGWDLFTEID(FTEID fteid);
	
	FTEID getS1USGWULFTEID();
	
	void setS1USGWULFTEID(FTEID fteid);
