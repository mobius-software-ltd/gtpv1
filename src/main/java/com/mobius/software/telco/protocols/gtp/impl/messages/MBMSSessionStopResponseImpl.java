...
import com.mobius.software.telco.protocols.gtp.api.messages.MBMSSessionStopResponse;

public class MBMSSessionStopResponseImpl extends AbstractGTPMessage implements MBMSSessionStopResponse
{
	private Cause cause;
	...
	{
		return MessageType.MBMS_SESSION_STOP_RESPONSE;
	}
