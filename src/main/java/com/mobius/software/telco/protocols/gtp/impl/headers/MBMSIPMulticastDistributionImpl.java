...
import com.mobius.software.telco.protocols.gtp.api.headers.HCIndicator;
import com.mobius.software.telco.protocols.gtp.api.headers.MBMSIPMulticastDistribution;

public class MBMSIPMulticastDistributionImpl extends AbstractTLV implements MBMSIPMulticastDistribution 
{
	...
	{
		return ElementType.MBMS_IP_MULTICAST_DISTRIBUTION;
	}
