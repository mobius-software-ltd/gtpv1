...
public interface PGWRestartNotification extends GTP2Message
{
	IPAddress getPGWIPAddress();
	
	void setPGWIPAddress(IPAddress ipAddress);
		
	IPAddress getSGWIPAddress();
	
	void setSGWIPAddress(IPAddress ipAddress);
