...
import com.mobius.software.telco.protocols.gtp.api.messages.ForwardRelocationCompleteAcknowledgement;

public class ForwardRelocationCompleteAcknowledgementImpl extends AbstractGTPMessage implements ForwardRelocationCompleteAcknowledgement
{
	private Cause cause;
	...
	{
		return MessageType.FORWARD_RELOCATION_COMPLETE_ACKNOWLEDGMENT;
	}
