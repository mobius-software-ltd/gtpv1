...
public interface LocationChangeNotificationResponse extends GTPMessage 
{
	IMSI getIMSI();
	...
	ChangeReportAction getChangeReportAction();
	
	void setChangeReportAction(ChangeReportAction action);
	
	CSGInformationReportingAction getCSGInformationReportingAction();
	
	void setCSGInformationReportingAction(CSGInformationReportingAction csgInformationReportingAction);
