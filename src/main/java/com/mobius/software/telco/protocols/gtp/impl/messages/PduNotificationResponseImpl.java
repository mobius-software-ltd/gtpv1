...
import com.mobius.software.telco.protocols.gtp.api.messages.PduNotificationResponse;

public class PduNotificationResponseImpl extends AbstractGTPMessage implements PduNotificationResponse
{
	private Cause cause;
	...
	{
		return MessageType.PDU_NOTIFICATION_RESPONSE;
	}
