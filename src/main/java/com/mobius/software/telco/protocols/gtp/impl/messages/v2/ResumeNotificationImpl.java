...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.ResumeNotification;

public class ResumeNotificationImpl extends AbstractGTP2Message implements ResumeNotification
{
	IMSI imsi;
	...
	{
		return GTP2MessageType.RESUME_NOTIFICATION;
	}
