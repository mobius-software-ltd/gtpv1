...
public interface ForwardAccessContextNotification extends GTP2Message
{
	RABContext getRABContext();
	
	void setRABContext(RABContext rabContext);
	
	SourceRNCPDCPContextInfo getSourceRNCPDCPContextInfo();
	
	void setSourceRNCPDCPContextInfo(SourceRNCPDCPContextInfo contextInfo);
	
	PDUNumbers getPDUNumbers();
	
	void setPDUNumbers(PDUNumbers pduNumbers);
	
	FContainer getEUTRANTransparentContainer();
	
	void setEUTRANTransparentContainer(FContainer container);
