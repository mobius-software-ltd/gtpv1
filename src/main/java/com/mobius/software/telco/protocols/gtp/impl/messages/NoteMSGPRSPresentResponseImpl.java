...
import com.mobius.software.telco.protocols.gtp.api.messages.NoteMSGPRSPresentResponse;

public class NoteMSGPRSPresentResponseImpl extends AbstractGTPMessage implements NoteMSGPRSPresentResponse
{
	private Cause cause;
	...
	{
		return MessageType.NOTE_MS_GPRS_PRESENT_RESPONSE;
	}
