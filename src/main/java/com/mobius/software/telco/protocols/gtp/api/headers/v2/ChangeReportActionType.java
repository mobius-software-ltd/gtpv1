...
{
	STOP_REPORTING(0),START_CGI_SAI(1),START_RAI(2),START_TAI(3),START_ECGI(4),START_CSG_SAI_AND_RAI(5),START_TAI_AND_ECGI(6),START_MACRO_ENODEBID_AND_EXTENDED_ENODEBID(7),START_TAI_MACRO_ENODEBID_AND_EXTENDED_ENODEBID(8);
