...
public interface UpdateBearerRequestBearerContextToBeModified extends TLV2
{
	...
	void setAdditionalProtocolConfigurationOption(AdditionalProtocolConfigurationOption apco);
	
	ExtendedProtocolConfigurationOptions getExtendedProtocolConfigurationOption();
	
	void setExtendedProtocolConfigurationOption(ExtendedProtocolConfigurationOptions epco);		
