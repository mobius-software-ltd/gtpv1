...
import com.mobius.software.telco.protocols.gtp.api.messages.MBMSNotificationRejectResponse;

public class MBMSNotificationRejectResponseImpl extends AbstractGTPMessage implements MBMSNotificationRejectResponse
{
	private Cause cause;
	...
	{
		return MessageType.MBMS_NOTIFICATION_REJECT_RESPONSE;
	}
