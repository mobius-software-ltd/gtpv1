...
import com.mobius.software.telco.protocols.gtp.api.messages.NodeAliveResponse;

public class NodeAliveResponseImpl extends AbstractGTPTagMessage implements NodeAliveResponse
{
	...
	{
		return MessageType.NODE_ALIVE_RESPONSE;
	}
