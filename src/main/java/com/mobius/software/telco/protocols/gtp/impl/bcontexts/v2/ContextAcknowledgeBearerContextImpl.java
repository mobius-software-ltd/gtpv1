...
public class ContextAcknowledgeBearerContextImpl extends BearerContextImpl implements ContextAcknowledgeBearerContext
{
	private EPSBearerID bearerID;
	private FTEID forwardingFTEID;
	...
	public List<TLV2> getTLVs() throws GTPParseException 
	{
		...
		if(forwardingFTEID==null)
			throw new GTPParseException("Forwarding FTEID not set");
	...
	@Override
	public void setForwardingFTEID(FTEID fteid) 
	{
		fteid.setInstance(0);
		this.forwardingFTEID=fteid;
	}
}