...
public class ExtendedRanapCauseImpl extends AbstractTLV implements ExtendedRanapCause 
{
	...
	{
		if(causeType!=null)
			buffer.writeShort(causeType.getValue());
		else
	...
	{
		causeType=RanapCauseType.fromInt(buffer.readShort());
	}
