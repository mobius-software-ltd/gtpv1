...
import com.mobius.software.telco.protocols.gtp.api.messages.FailureReportResponse;

public class FailureReportResponseImpl extends AbstractGTPMessage implements FailureReportResponse
{
	private Cause cause;
	...
	{
		return MessageType.FAILURE_REPORT_RESPONSE;
	}
