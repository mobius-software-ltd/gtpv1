...
public interface IdentificationResponse extends GTPMessage 
{
	Cause getCause();
	...
	AuthenticationTriplet getAuthenticationTriplet();
	
	void setAuthenticationTriplet(AuthenticationTriplet triplet);
	
	AuthenticationQuintiplet getAuthenticationQuintiplet();
	
	void setAuthenticationQuintiplet(AuthenticationQuintiplet quintiplet);
