...
import com.mobius.software.telco.protocols.gtp.api.messages.MBMSNotificationResponse;

public class MBMSNotificationResponseImpl extends AbstractGTPMessage implements MBMSNotificationResponse
{
	private Cause cause;
	...
	{
		return MessageType.MBMS_NOTIFICATION_RESPONSE;
	}
