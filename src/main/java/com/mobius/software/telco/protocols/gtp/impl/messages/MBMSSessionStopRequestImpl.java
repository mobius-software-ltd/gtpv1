...
import com.mobius.software.telco.protocols.gtp.api.messages.MBMSSessionStopRequest;

public class MBMSSessionStopRequestImpl extends AbstractGTPMessage implements MBMSSessionStopRequest
{
	...
	{
		return MessageType.MBMS_SESSION_STOP_REQUEST;
	}
