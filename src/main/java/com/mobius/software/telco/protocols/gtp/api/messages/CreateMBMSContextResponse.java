...
public interface CreateMBMSContextResponse extends GTPMessage 
{
	Cause getCause();
	...
	void setMBMSProtocolConfigurationOptions(MBMSProtocolConfigurationOptions protocolConfigurationOptions);
