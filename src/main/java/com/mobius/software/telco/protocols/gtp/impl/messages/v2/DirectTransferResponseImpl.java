...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.DirectTransferResponse;

public class DirectTransferResponseImpl extends AbstractGTP2Message implements DirectTransferResponse
{
	IMSI sessionID;
	...
	{
		return GTP2MessageType.DIRECT_TRANSFER_RESPOSE;
	}
