...
import com.mobius.software.telco.protocols.gtp.api.messages.InitiatePdpContextActivationResponse;

public class InitiatePdpContextActivationResponseImpl extends AbstractGTPMessage implements InitiatePdpContextActivationResponse
{
	private Cause cause;
	...
	{
		return MessageType.INITIATE_PDP_CONTEXT_ACTIVATION_RESPONSE;
	}
