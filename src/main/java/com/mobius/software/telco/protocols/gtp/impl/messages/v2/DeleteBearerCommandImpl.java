...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.DeleteBearerCommand;
...
public class DeleteBearerCommandImpl extends AbstractGTP2Message implements DeleteBearerCommand
{
	...
	{
		return GTP2MessageType.DELETE_BEARER_COMMAND;
	}
	...
	@Override
	public void setULITimestamp(ULITimestamp recovery) 
	{
		recovery.setInstance(0);
		this.uliTimestamp=recovery;
	}
