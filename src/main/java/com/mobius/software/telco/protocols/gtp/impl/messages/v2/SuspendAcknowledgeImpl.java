...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.SuspendAcknowledge;

public class SuspendAcknowledgeImpl extends AbstractGTP2Message implements SuspendAcknowledge
{
	Cause cause;
	...
	{
		return GTP2MessageType.SUSPEND_ACKNOWLEDGE;
	}
