...
import com.mobius.software.telco.protocols.gtp.api.messages.SendRoutingInfoForGPRSRequest;

public class SendRoutingInfoForGPRSRequestImpl extends AbstractGTPMessage implements SendRoutingInfoForGPRSRequest
{
	private IMSI imsi;
	...
	{
		return MessageType.SEND_ROUTING_INFORMATION_FOR_GPRS_REQUEST;
	}
