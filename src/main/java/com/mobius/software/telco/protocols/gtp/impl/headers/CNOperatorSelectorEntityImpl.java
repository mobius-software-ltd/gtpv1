...
import com.mobius.software.telco.protocols.gtp.api.headers.SelectionEntity;

public class CNOperatorSelectorEntityImpl extends AbstractTLV implements CNOperatorSelectionEntity 
{
	...
	{
		return ElementType.CN_OPERATOR_SELECTION_ENTITY;
	}
