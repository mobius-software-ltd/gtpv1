...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.RelocationCancelRequest;

public class RelocationCancelRequestImpl extends AbstractGTP2Message implements RelocationCancelRequest
{
	IMSI imsi;
	MEI mei;
	...
	{
		return GTP2MessageType.RELOCATION_CANCEL_REQUEST;
	}
