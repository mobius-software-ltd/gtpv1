...
import com.mobius.software.telco.protocols.gtp.api.messages.RelocationCancelRequest;

public class RelocationCancelRequestImpl extends AbstractGTPMessage implements RelocationCancelRequest
{
	private IMSI imsi;
	...
	{
		return MessageType.RELOCATION_CANCEL_REQUEST;
	}
