...
public class AbsoluteTimeOfMBMSDataTransferImpl extends AbstractTLV2 implements AbsoluteTimeOfMBMSDataTransfer 
{
	...
	{
		return GTP2ElementType.ABSOLUTE_TIME_OF_MBMS_DATA_TRANSFER;
	}
	...
	protected void writeValue(ByteBuf buffer) throws MissingArgumentException 
	{
		...
		if(fractions!=null)
			buffer.writeInt(fractions.intValue());
		else
	...
	protected void readValue(ByteBuf buffer, Integer length) 
	{
		...
		fractions+=buffer.readUnsignedInt();
	}
	...
	@Override
	public void setFractions(Long fractions) 
	{
