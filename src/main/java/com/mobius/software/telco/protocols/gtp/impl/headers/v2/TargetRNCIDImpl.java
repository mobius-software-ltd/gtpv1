...
public class TargetRNCIDImpl extends AbstractTLV2 implements TargetRNCID 
{
	...
	{
		return GTP2ElementType.TARGET_RNC_ID;
	}
	...
	protected void readValue(ByteBuf buffer, Integer length) 
	{
		...
		rncID=buffer.readUnsignedShort();		
	}
