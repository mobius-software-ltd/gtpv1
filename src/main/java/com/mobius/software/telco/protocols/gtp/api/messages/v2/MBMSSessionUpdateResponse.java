...
public interface MBMSSessionUpdateResponse extends GTP2Message
{
	Cause getCause();
	
	void setCause(Cause cause);
	
	MBMSDistributionAcknowledgement getMBMSDistributionAcknowledgement();
	
	void setMBMSDistributionAcknowledgement(MBMSDistributionAcknowledgement mbmsDistributionAcknowledgement);
	
	FTEID getSGSNFTEID();
	
	void setSGSNFTEID(FTEID fteid);
