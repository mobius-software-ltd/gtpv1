...
public class SignalingPriorityIndicationImpl extends AbstractTLV implements SignalingPriorityIndication 
{
	...
	{
		return ElementType.SIGNALING_PRIORITY_INDICATION;
	}
