...
public interface UERegistrationQueryResponse extends GTP2Message
{
	Cause getCause();
	...
	PLMNID getSelectedCoreNetworkOperatorIdentifier();
	
	void setSelectedCoreNetworkOperatorIdentifier(PLMNID selectedCoreNetworkOperatorIdentifier);	
