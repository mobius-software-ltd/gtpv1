...
import com.mobius.software.telco.protocols.gtp.api.messages.ForwardSRNSContentAcknowledgement;

public class ForwardSRNSContentAcknowledgementImpl extends AbstractGTPMessage implements ForwardSRNSContentAcknowledgement
{
	private Cause cause;
	...
	{
		return MessageType.FORWARD_SRNS_CONTEXT_ACKNOWLEDGMENT;
	}
