...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.SRVCCPSToCSCancelNotification;

public class SRVCCPSToCSCancelNotificationImpl extends AbstractGTP2Message implements SRVCCPSToCSCancelNotification
{
	IMSI imsi;
	...
	{
		return GTP2MessageType.SRVCC_PS_TO_CS_CANCEL_NOTIFICATION;
	}
