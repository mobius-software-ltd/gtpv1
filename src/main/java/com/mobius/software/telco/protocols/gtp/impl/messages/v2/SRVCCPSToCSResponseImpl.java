...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.SRVCCPSToCSResponse;

public class SRVCCPSToCSResponseImpl extends AbstractGTP2Message implements SRVCCPSToCSResponse
{
	Cause cause;
