...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.ResumeAcknowledge;

public class ResumeAcknowledgeImpl extends AbstractGTP2Message implements ResumeAcknowledge
{
	Cause cause;
	...
	{
		return GTP2MessageType.RESUME_ACKNOWLEDGE;
	}
