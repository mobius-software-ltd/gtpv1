...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.StopPagingIndication;

public class StopPagingIndicationImpl extends AbstractGTP2Message implements StopPagingIndication
{
	IMSI imsi;
	...
	{
		return GTP2MessageType.STOP_PAGING_INDICATION;
	}
