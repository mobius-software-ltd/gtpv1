...
import com.mobius.software.telco.protocols.gtp.api.messages.v2.RelocationCancelResponse;

public class RelocationCancelResponseImpl extends AbstractGTP2Message implements RelocationCancelResponse
{
	private Cause cause;
	...
	{
		return GTP2MessageType.RELOCATION_CANCEL_RESPONSE;
	}
