...
import com.mobius.software.telco.protocols.gtp.api.messages.SGSNContextAcknowledge;

public class SGSNContextAcknowledgeImpl extends AbstractGTPMessage implements SGSNContextAcknowledge
{
	private Cause cause;
	...
	{
		return MessageType.SGSN_CONTEXT_ACKNOWLEDGE;
	}
	...
	{
		return this.sgsnAddressForTraffic;
	}
